...
export function MainFolderAccordion({ folder, sessions, allFolders, onDeleteSession, onRenameSession, onRenameFolder, onDeleteFolder, onMoveFolder, onMoveTab, onMoveMultiTabs, onMoveTabToFolder, onMoveMultiTabsToFolder, onMergeSessions, onDeleteTab, onTabHover, pinnedLinks, onPinTab, onUnpinTab, onDropPinnedLinkToFolder, onDropPinnedLinkToSession, onReorderFolder, onReorderSession, onReorderTab, selectedTabs, onToggleTabSelection, theme }: Props) {
    ...
    return (
        <div className={`relative mb-1.5 last:mb-0 bg-white dark:bg-[#1a1a1a] rounded-2xl border transition-all ${isDragOver && !folderDropPos
            ...
            >
                ...
                <div className="relative" ref={menuRef}>
                    <button
                        ...
                        className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 p-1 rounded hover:bg-gray-200 dark:hover:bg-[#333] transition-colors"
                    >
            ...
            {isExpanded && (
                <>
                    <hr className="mx-4 border-gray-100 dark:border-[#333]" />
                    <div className="p-4 space-y-1.5 bg-gray-50/50 dark:bg-transparent rounded-b-2xl">
                        {sessions.length === 0 ? (
