            ...
            >
                ...
                >
                    ...
                    <button onClick={() => onSetActive("all")} className="flex items-center gap-1.5 flex-1 min-w-0">
                        <BoxFolderIcon size={16} className={`flex-shrink-0 ${isRootDragOver ? "text-blue-500" : activeFolderId === "all" ? "text-blue-500 dark:text-blue-400" : "text-gray-400 dark:text-gray-500"}`} />
