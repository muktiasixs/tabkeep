    ...
    return (
        <div className="relative" ref={ref}>
            <button
                ...
                className="flex items-center gap-1 text-[11px] text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 font-bold transition-colors px-2 py-1 rounded-lg hover:bg-gray-100 dark:hover:bg-white/5"
            >
                <MoveRight size={11} />
                Pindahkan
            </button>
